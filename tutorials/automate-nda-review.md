...
You can create your own ontology from scratch, or download our [example NDA review ontology]([../assets/nda-review-ontology.yaml](https://github.com/getbluemorpho/blue-morpho/blob/main/assets/review%20nda%20ontology.yaml) and import it in the app using the “Import from YAML file” function.
